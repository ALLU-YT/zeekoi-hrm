                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        SizedBox(
                            width:
                                MediaQuery.of(context).size.width * 0.1 - 25),
                        Padding(
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      for (var payroll in payrollList)
                                        if (payroll.essentialsAllowances !=
                                            null)
                                          for (var allowance
                                              in payroll.essentialsAllowances!)
                                            for (var i = 0;
                                                i <
                                                    allowance['allowance_names']
                                                        .length;
                                                i++)
                                              Padding(
                                                padding:
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      for (var deduction in deductionList)
                                        if (deduction.essentialsDeductions !=
                                            null)
